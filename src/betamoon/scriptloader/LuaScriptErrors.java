...
public final class LuaScriptErrors {
    ...
    public static synchronized void add(String script, String message) {
        ...
        entries.add(new ScriptIssue(scriptName, detail, false));
    }
     ...
     */
    public static synchronized void addWarning(String script, String message) {
        String scriptName = normalize(script, "Unknown");
        String detail = normalize(message, "Unknown warning");
        entries.add(new ScriptIssue(scriptName, detail, true));
    }
