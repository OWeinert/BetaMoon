...
public final class BlockBrokenHook implements HookModule {
    ...
    private static final String CALLBACK_OWNER = "betamoon/instrumentation/hooks/block/BlockBrokenCallbacks";
    ...
    public void register(HookRegistrar registrar) {
        ...
        HandlerRef completed = HandlerRef.of(CALLBACK_OWNER, "afterBlockBroken", "(Z" + SNAPSHOT_DESCRIPTOR + ")V");
