...
public final class AzertyKeyLayout extends AbstractKeyLayoutMapper {
    @Override
    protected void registerLetters() {
        add(Keyboard.KEY_A, 'q', 'Q');
